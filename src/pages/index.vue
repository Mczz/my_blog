  ...
  <div class="index-content">
    ...
    <el-row :gutter="20" class="content">
      ...
      <el-col :span="8">
        ...
        <zhuanti title="标签云">
          <ul>
            <tag v-for="(item,index) in tags" :key="index"  :taginfo='item' :style="{backgroundColor:randomColor()}"/>
          </ul>
        </zhuanti>
        <zhuanti title="推荐文章">
          <recommend />
...
export default {
  ...
  data () {
    return {
      imglist:[require("@/assets/images/banner00.jpg"),require("@/assets/images/banner01.jpg"),require("@/assets/images/banner02.jpg")],
      blogList:[{
        title:'程序员职业生涯该如何发展？',
        text:'四年的时间，学习专业课程，临近毕业恨不能找个简单轻松的工作远离编程，可是微薄的工资跟专业相比，找个专业的工作工资能高好几倍。好不容易找到个跟专业符合的工作，五年...',
        ctime:'2018-07-15',
        href:'#',
        tag:'慢生活',
        view:7,
      ...
      tags:[
        {tagname:'博客',href:'#'},{tagname:'博w客',href:'#'},
        {tagname:'博das客',href:'#'},{tagname:'博客',href:'#'},{tagname:'博asd客',href:'#'},{tagname:'博客',href:'#'}
      ] 
    }
  },
  computed:{
